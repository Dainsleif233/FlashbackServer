...
|---|:---:|:---:|:---:|
| Platform | Paper/Folia 1.16.1, 1.21.5–1.21.11, 26.2 | Paper | Fabric |
...
1. Requires **Paper** (or a Paper fork such as Folia) for **Minecraft 1.16.1 or 1.21.5–1.21.11, 26.2**.
...
- Minecraft **1.16.1**, **1.21.5–1.21.11**, **26.2**
