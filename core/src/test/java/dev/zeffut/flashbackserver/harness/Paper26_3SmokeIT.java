...
/** Exercises the deployed shaded plugin with the Java-25 Paper 26.3 runtime. */
@Tag("integration")
class Paper26_3SmokeIT {
    @Test
    void bootsLoadsPluginAndStopsCleanly(@TempDir Path dir) throws Exception {
        try (PaperTestServer server = PaperTestServer.start(dir, 25604, "paper", "26.3")) {
